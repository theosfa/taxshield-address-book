    ...
    <div class="contain">
      <div class="search-bar">
        <div class="search-container">
          <input type="text" placeholder="Search" class="inp" required>
        </div>
        <div class="buttons">
            <router-link to="/" class="fav-all">All</router-link>
          <button class="all-fav">Favorites</button>
        </div>
      </div>
      <div class="all-container">
        <h2>Sorry this feature is in the stage of creating</h2>
      </div>
    </div>
